...
export const requestReturnBook = async (data) => {
    const res = await apiClient.post(`${apiHistoryBook}/request-return`, data);
    return res.data;
};

export const requestApproveReturnBook = async (data) => {
    const res = await apiClient.post(`${apiHistoryBook}/approve-return`, data);
    return res.data;
};

export const requestExtendBook = async (data) => {
    const res = await apiClient.post(`${apiHistoryBook}/extend`, data);
    return res.data;
};
...
export const requestMarkAsReadNotification = async (notificationId) => {
    const res = await apiClient.put(`${apiNotification}/${notificationId}/read`);
    return res.data;
};